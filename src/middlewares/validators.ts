...
export const validateRegister = [
  ...
  body('schoolIdCardURL').optional().isURL().withMessage('School ID Card must be a url'),
  body('nin')
    .optional()
    .isString()
...
export const validateVerificationRequest = [
  ...
  .isIn(['verified', 'rejected']).withMessage('Status must be either "verified" or "rejected".'),
